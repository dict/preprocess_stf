...
python 01-df_anchor_i.py $root/clip  $root/df_info --gpu 0,1,2,3 --JOB_NUM 24 --reference_face  $root/hunet.png --stride 30
...
python 02-crop_with_fan.py  $root/clip $root/df_info  $root/preprocess --gpu 0,1,2,3 --JOB_NUM 24
